        ...
        <div class="box-content">
            <div class="row-fluid">
                ...
                <form name="params" action='<?php $_SERVER['PHP_SELF']; ?>' method="POST">
                    ...
                    <button class="btn btn-primary noty" data-noty-options="{&quot;text&quot;:&quot;<span style='float:left; text-align:left;'> This is the time  PlayatChat will wait between two requests (messages sent)<br/> Increase the time interval if you want to reduce server resource usage<br/> 1 second is the default time interval.</span>&quot;,&quot;layout&quot;:&quot;center&quot;,&quot;type&quot;:&quot;success&quot;}"><i class="icon-question-sign icon-white"></i></button>
                    <br/><br/>
                    ...
                    <span class="info_text">Turning this on compresses PlayatChat files for faster load </span><br/>                      
                    <br/><br/>
