        ...
        <div id="tabs">
            ...
            <div id="client">
                ...
                <ol id ="parametejrs" style="list-style-type: upper-roman;">
                    ...
                    <li>
                        <p>Do not load Playat Chat for guests ?</p><br/>
                    ...
                    <li>
                        ...
                        <?php if (in_array($param->driver, $param->joomla_drivers) == true) { 
                            ...
                            <br/><em>if left empty Playat will fetch users as per the previous option else will override it.</em>'; 
...
//echo $param->default_param("link_profile", "enabled");
            ...
            <div id="server">
                <ol  style="list-style-type: upper-roman;">
                    ...
                    <li><hr/>
                        ...
                        Note:<br/>
                        1. This is the time Playat will wait between two requests (messages sent)<br/>
                    ...
                    <li><hr/>
                        ...
                        Note:<br/>
                        This handler compresses Playat files for faster load <br/>                      
                        <br/><br/><hr/>
                    </li>
            ...
            <div id ="account">
                <ol style="list-style-type: upper-roman;">
                    <!--<li>
                       Change Playat administrator password<br/><br/>
