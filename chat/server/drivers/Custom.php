...
//------------------------------------------------------------------------------
    //AVATAR_URL_START
        public function avatar_url1($res) {
...
//CUSTOM_USERS_QUERY_END
       ...
       // $list = $this->db->query($query)->fetchAll();
		...
		{  
		//$list[$i]['avatar'] = 'http://192.168.0.25/playat/themes/site/images/logo_small.png'; //update the original array
		 $list[$i]['avatar'] = $_SESSION['avatar'];
		$i++; 
		}
